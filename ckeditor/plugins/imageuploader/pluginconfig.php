...
$foldershistory[] = $useruploadfolder;
    ...
    $useruploadfolder = "arcteam/img/post";
    $useruploadpath = $usersiteroot."$useruploadfolder/";
    $foldershistory[] = "arcteam/img/post";


    $useruploadfolder = "arcteam/ckeditor/plugins/imageuploader/uploads";
    $useruploadpath = $usersiteroot."$useruploadfolder/";
    $foldershistory[] = "arcteam/ckeditor/plugins/imageuploader/uploads";
