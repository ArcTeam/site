...
<nav>
  <ul>
    ...
    <li><a href="lavori.php" title="Sul campo" id="works"><i class="fa fa-wrench"></i> <span>works</span></a></li>
    <li><a href="progetti.php" title="Free as freedom" id="project"><i class="fa fa-cogs"></i> <span>project</span></a></li>
    ...
    <li class="logged">
        ...
        <ul id="settingUl" class="subMenu">
            <li><a href="attivita.php" title="elenco attività"><i class="fa fa-wrench"></i> attività</a></li>
            <li><a href="diario.php" title="gestione attività giornaliere"><i class="fa fa-calendar"></i> diario</a></li>
            <li><a href="fatture.php" title="elenco fatture"><i class="fa fa-eur"></i> fatture</a></li>
